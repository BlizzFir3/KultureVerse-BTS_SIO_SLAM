...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$message = createAccount($username, $email_adress, $password);
	if ($message == true) {
	...
	<body class="d-flex align-items-center py-4 bg-body-tertiary">
		...
		<main class="form-signin w-100 m-auto">
			...
			<form action="register.php" method="post">
				...
				<div class="form-floating">
					<input type="username" name="username" class="form-control mb-3" id="floatingInput" placeholder="Username" required>
				...
				<input class="btn btn-success w-100 py-2" name="envoyer" type="submit" value="S'enregistrer">
			</form>
		</main>
